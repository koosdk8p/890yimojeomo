...
<body class='with-3d-shadow with-transitions'>
    ...
    <div class="page-body" roll="main" id="status-main" style="float: left; width: 55%; padding-top: 7em;">
            <div id="owl-demo" class="owl-carousel">
                <div class="item"><img src="<c:url value='/resources/images/carousel/carousel1.png' />" alt="Carousel1"></div>
                <div class="item"><img src="<c:url value='/resources/images/carousel/carousel2.png' />" alt="Carousel2"></div>
                <div class="item"><img src="<c:url value='/resources/images/carousel/carousel3.png' />" alt="Carousel3"></div>
            </div>
    </div>
